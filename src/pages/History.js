        ...
        <article className="history-about">
          <Fade duration={1000}>
            <section className="history-card">
              ...
              Hispanic Professional Engineers (SHPE). The history of
              ...
              <section>
                ...
                <div>
                  ...
                  <p className="history-answer">
                    ...
                    during COVID 19. LCC was incredibly important to my time at
                    MIT. It felt like home when I needed a reminder of what that
                    felt like - everything from the food caterings we ordered,
                    the LUCHA socials, being able to pamper parents during
                    <a href="https://youtu.be/YV9IT526Ycg">
                      {" "}
                      Cena a las Seis
                    </a>{" "}
                    - it was really awesome to be a part of 🙂
                  </p>
                </div>
                <div>
                  <p className="history-question">
                    Any advice for incoming students looking to get involved
                    with the LCC or related clubs?
                  </p>
                  <p className="history-answer">
                    For students wanting to join LCC, I’d suggest for them to
                    start by joining the chat or coming to pset in the lounge! I
                    think a lot of what makes LCC a community is having organic
                    interactions in the lounge and feeling like they can join
                    social events with people they already know - so just coming
                    to hang out and being open to meeting people while pseting
